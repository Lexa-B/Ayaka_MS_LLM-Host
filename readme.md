...
## To run in Docker:
*After building, it will have to download the models from HuggingFace Hub at runtime, so it will take a while to initialize anytime a new model is requested. caveat emptor*.
